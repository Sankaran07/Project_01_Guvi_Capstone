...
emplyee_delete_selected = driver.find_element(By.XPATH, '//*[@id="app"]/div[1]/div[2]/div[2]/div/div[2]/div[2]/div/div/button/i')
emplyee_delete_selected.click()
# print('emplyee_delete_selected')
sleep(2)
